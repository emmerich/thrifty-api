...
public class WikiaGoldValueParser implements GoldValueParser<WikiaText> {
    ...
    public static void main(String [] args) {
        WikiaGoldValueParser p = new WikiaGoldValueParser();
        ...
        System.out.println(p.extractSellValue(new WikiaText(t, null)));
    }

    @Override
    public int extractSellValue(WikiaText parseable) {
        try {
            String v = parseable.getProperty("sell").replace("\\n", "");
            return parseGoldValue(v);
    ...
    @Override
    public int extractCost(WikiaText parseable) {
